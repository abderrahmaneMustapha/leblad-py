class TestCases:
    ...
    def test_cases_getWilayaByZipCode(self):
        ...
        "expected" :  {
            ...
            "postalCodes": [
                ...
                14018, 14019, 14020, 14021, 14023, 14024, 14025, 14026, 14027,
    ...
    def test_cases_getWilayaByDairaName(self):
    ...
    def test_cases_getWilayasByPhoneCode(self):
        cases = [
            {
                "input" : 32,
                "expected" : "Oum El Bouaghi"
    ...
    def test_cases_getZipCodesForWilaya(self):
        cases = [
            {
                "input" :  20,
                "expected" : [20000, 20001, 20002, 20003, 20004, 20005, 20006, 20007, 20008, 20009, 20010, 20011, 20012, 20013, 20014, 20015, 20016, 20017, 20018, 20019, 20020, 20021, 20022, 20023, 20024, 20025, 20026, 20027, 20028, 20029, 20030, 20031, 20032, 20033, 20034, 20035, 20036, 20037, 20038, 20039, 20040, 20041, 20042, 20043, 20044, 20045, 20046, 20047, 20048, 20049, 20050, 20051],
            },
             {
                "input" : 38,
                "expected" : [38000, 38001, 38002, 38003, 38004, 38005, 38006, 38007, 38008, 38009, 38010, 38011, 38012, 38013, 38014, 38015, 38016, 38017, 38018, 38019, 38020, 38021, 38022, 38023, 38024, 38025, 38026, 38027, 38028, 38029, 38030, 38031, 38032, 38033, 38034, 38035, 38036, 38037, 38038, 38039, 38040, 38041, 38042, 38043],
            },
            {
                "input" : 48,
                "expected" : [48000, 48001, 48002, 48003, 48004, 48005, 48006, 48007, 48008, 48009, 48010, 48011, 48012, 48013, 48014, 48015, 48016, 48017, 48018, 48019, 48020, 48021, 48022, 48023, 48024, 48025, 48026, 48027, 48028, 48029, 48030, 48031, 48032, 48033, 48034, 48035, 48036, 48037, 48038, 48039, 48040, 48041, 48042, 48043, 48044, 48045, 48046, 48047, 48048, 48049, 48050, 48051, 48052, 48053, 48054, 48055, 48056, 48057, 48058, 48059, 48060, 48061, 48062, 48063, 48064, 48065, 48066, 48067, 48068, 48070, 48071, 48072, 48073, 48074, 48075, 48076, 48077, 48078, 48079, 48080],
            }, 
            {
                "input" : 1,
                "expected" : [1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1016, 1017, 1018, 1019, 1020, 1021, 1022, 1023, 1024, 1025, 1026, 1027, 1028, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1036, 1037, 1038, 1039, 1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1069, 1070, 1071, 1072, 1073, 1074],
            }
        ]

        return cases

    def test_cases_getAdjacentWilaya(self):
        cases = [
            {
                "input" :  1,
                "expected" : [37, 8, 32, 3, 47, 11]
            },
             {
                "input" : 6,
                "expected" : [15, 10, 34, 19, 18]
            },
            {
                "input" : 48,
                "expected" : [29, 27, 2, 38, 14]
            }, 
            {
                "input" : 26,
                "expected" : [17, 38, 44, 9, 10, 28]
            }
        ]
